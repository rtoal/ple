...
main = 
    let 
        professorTang = Professor 
            { profFirstName = "Nigel"
            , profLastName = "Tang"
            , almaMaters = ["LMU", "Columbia"]
            , degrees = 
                [ "BS, Computer Science"
                , "PhD, Computer and Information Security"
                ]
            , yearsAtUniversity = 12
            , tenured = True
            , classesCurrentlyTeaching = 
                [ "Theory of Computation"
                , "Introduction to Information Security"
                , "Data Analytics I", "Algorithms"
                ]
        ...
        theoryOfComputation = Class 
            ...
            , studentsEnrolledByUniversityId =
                [ 1556, 7793, 2785, 2400, 7316, 3156
                , 4121, 8578, 7621, 8303, 8533, 9807
                ]
    ...
    in do 
        ...
        guard $ almaMaters professorTang ==  ["LMU", "Columbia"]
        guard $ degrees professorTang == 
            ["BS, Computer Science", "PhD, Computer and Information Security"]
        guard $ yearsAtUniversity professorTang == 12
        guard $ tenured professorTang == True
        guard $ classesCurrentlyTeaching professorTang ==
            [ "Theory of Computation"
            , "Introduction to Information Security"
            , "Data Analytics I", "Algorithms"
            ]
        guard $ profDepartment professorTang == "Computer Science"
        guard $ college professorTang == 
            "School of Applied Mathematics and Sciences"
        guard $ studentFirstName judyGoodman == "Judy"
        guard $ studentLastName judyGoodman == "Goodman"
        guard $ year judyGoodman == "Junior"
        guard $ degreesPursuing judyGoodman ==
            [ "BS, Computer Science (Major)"
            , "BS, Bioinformatics (Major)"
            ]
        guard $ gpa judyGoodman == 3.8
        guard $ classesCurrentlyTaking judyGoodman == 
            [ "Theory of Computation"
            , "Organic Chemistry II"
            , "Introduction to Neurology"
            , "Introduction to Information Security"
        ...
        guard $ studentsEnrolledByUniversityId theoryOfComputation ==
            [ 1556, 7793, 2785, 2400, 7316, 3156, 4121, 8578
            , 7621, 8303, 8533, 9807
            ]
